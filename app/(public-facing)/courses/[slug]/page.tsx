          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              {course.chapters.reduce(
                (tot, chapter) => tot + chapter.lessons.length,
                0
              ) || 0}{" "}
              Lessons
            </div>
                  ...
                  <CollapsibleContent>
                    <div className="border-t bg-muted/20">
                      <div className="p-5 pt-4 space-y-3">
                        {chapter.lessons.map((lesson, _) => (
                          <div key={lesson.id}>
                            {/* <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-muted">
                              <IconPlayerPlay className="text-muted-foreground group-hover:text-primary transition-colors" />
                            </div> */}
              ...
              <div className="mb-6 space-y-3 rounded-lg bg-muted p-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="">
                      <p className="text-sm font-medium">Total Lectures</p>
                      <p className="text-sm text-muted-foreground">
                        {course.chapters.reduce(
                          (tot, chapter) => tot + chapter.lessons.length,
                          0
